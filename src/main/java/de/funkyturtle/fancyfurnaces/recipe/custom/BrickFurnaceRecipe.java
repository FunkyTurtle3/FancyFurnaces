...
public class BrickFurnaceRecipe extends AbstractCookingRecipe {
    public BrickFurnaceRecipe(String group, CookingBookCategory category, Ingredient input, ItemStack result, float experience, int cookingTime) {
    ...
    public @NotNull RecipeSerializer<? extends AbstractCookingRecipe> getSerializer() {
        return FFRecipeSerializers.BRICK_FURNACE_RECIPE_SERIALIZER.get();
    }

    @Override
    public @NotNull RecipeType<? extends AbstractCookingRecipe> getType() {
        return FFRecipeTypes.BRICK_FURNACE_RECIPE.get();
    }

    @Override
    public @NotNull RecipeBookCategory recipeBookCategory() {
        return switch (this.category()) {
            case BLOCKS -> FFRecipeBookCategories.BRICK_FURNACE_BLOCKS_CATEGORY.get();
            case FOOD, MISC -> FFRecipeBookCategories.BRICK_FURNACE_MISC_CATEGORY.get();
        };
    }

    @Override
    protected @NotNull Item furnaceIcon() {
        return FFBlocks.BRICK_FURNACE.asItem();
    }
}
