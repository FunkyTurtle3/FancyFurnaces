...
public class BrickFurnaceScreen extends AbstractFurnaceScreen<BrickFurnaceMenu> {
    ...
    private static final List<RecipeBookComponent.TabInfo> TABS = List.of(
            new RecipeBookComponent.TabInfo(Items.CLAY_BALL, FFRecipeBookCategories.BRICK_FURNACE_MISC_CATEGORY.get()),
            new RecipeBookComponent.TabInfo(Items.GREEN_GLAZED_TERRACOTTA, FFRecipeBookCategories.BRICK_FURNACE_BLOCKS_CATEGORY.get())
    );
