...
public class GlassFurnaceScreen extends AbstractFurnaceScreen<GlassFurnaceMenu> {
    ...
    private static final List<RecipeBookComponent.TabInfo> TABS = List.of(
            new RecipeBookComponent.TabInfo(Items.GLASS, FFRecipeBookCategories.GLASS_FURNACE_BLOCKS_CATEGORY.get())
    );

    public GlassFurnaceScreen(GlassFurnaceMenu menu, Inventory playerInventory, Component title) {
